...
if !filereadable(vimplug_exists)
  if !executable(curl_exists)
    echoerr "Please install Curl or vim-plug first!"
    execute "q!"
  endif
...
if filereadable(expand("~/.config/nvim/.rc.local.bundles"))
  source ~/.config/nvim/.rc.local.bundles
endif
...
if filereadable(expand("~/.config/nvim/.rc.local"))
  source ~/.config/nvim/.rc.local
endif
